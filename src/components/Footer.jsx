...
<nav className='block md:space-x-8 space-x-2 items-center p-4 md:ml-16 text-violet-900 md:text-2xl text-sm font-bold font-sans '>
...
<div>
    ...
    <div>
      <h3 className='block space-x-10 items-center p-4 ml-4 text-violet-900 text-2xl font-bold font-sans '>Terminos y condiciones</h3>
      <h3></h3>
    </div>
</div>      
    </div>
