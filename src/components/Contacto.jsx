...
const Contacto = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_chxzyle', 'template_ajltz9i', form.current, 'jfzFx7gOy8pa3NgF5')
      .then((result) => {
    ...
    <div className='bg-gray-100 p-6 md:flex block ' id='contactos'>
      ...
      <form className='mb-20 mt-16'  ref={form} onSubmit={sendEmail}>
        ...
        <fieldset className='' >
            ...
            <input  className='border-none p-3 w-1/3 rounded-md m-4 shadow-md responsive-form'  name='nombre' id='nombre' required placeholder='Tu nombre'/>
            <input  className='border-none p-3 w-1/3 rounded-md m-4 shadow-md responsive-form' required name='telefono' id='telefono' placeholder='Tu telefono'/>
       </fieldset>


       <fieldset>
            <input className='border-none p-3 w-1/3 rounded-md m-4 shadow-md responsive-form' required name='email' id='email ' placeholder='Email'/>
            <input className='border-none p-3 w-1/3 rounded-md m-4 shadow-md responsive-form' name='cliente' id='cliente' placeholder='Indique si es empresa'/>
        ...
        <input type='submit' className='bg-violet-900 p-4 m-4 w-1/5 rounded-md shadow-md text-white font-semibold hover:p-3'value='Enviar' />
