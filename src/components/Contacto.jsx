  ...
  return (
    <div className='bg-gray-100 p-6 md:flex block ' id='contactos'>
      <div className='md:w-1/2'>
        ...
        <h3 className='text-2xl text-center mt-10 text-gray-900'>Pide presupiestos sin compromisos</h3>
      ...
      <form className='mb-20 mt-16'  ref={form} onSubmit={sendEmail}>
        ...
        <fieldset className='' >
            ...
            <input  className='border-none p-2 rounded-md m-4 shadow-md'  name='nombre' id='nombre' required placeholder='Tu nombre'/>
            <input  className='border-none p-2 rounded-md m-4 shadow-md' required name='telefono' id='telefono' placeholder='Tu telefono'/>
       </fieldset>


       <fieldset>
            <input className='border-none p-2 rounded-md m-4 shadow-md' required name='email' id='email ' placeholder='Email'/>
            <input className='border-none p-2 rounded-md m-4 shadow-md' name='cliente' id='cliente' placeholder='Indique si es empresa'/>

        </fieldset>

        <fieldset>
            <textarea className='border-none p-2 rounded-md h-64 w-3/4 shadow-md' required name='mensaje' id='mensaje'>Comentanos en que podemos ayudarte</textarea>
        </fieldset>
